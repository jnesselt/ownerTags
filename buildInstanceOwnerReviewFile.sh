...
~/ownerTags/removeTaggedInstances.py ~/data/ownerTags/tempfile1.dat ~/data/ownerTags/tempfile2.dat $environment $region
~/ownerTags/addExceededTagCounts.py ~/data/ownerTags/tempfile2.dat ~/data/ownerTags/tempfile3.dat $environment $region

# Remove Teminated Instances
grep -v ^i-.........terminated ~/data/ownerTags/tempfile3.dat > ~/data/ownerTags/$environment-$region-ownerTags.dat
...
rm -f ~/data/ownerTags/tempfile3.dat
